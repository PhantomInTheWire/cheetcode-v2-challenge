...
import { isServerDevMode } from "./myEnv";
import { requireAuthenticatedGithub } from "./request-auth";
import { evalWithDeadline } from "./quickjsTimeout";
import { resolveSubmittedFunction } from "./quickjsResolve";
import { buildArgs } from "./testcaseArgs";
import {
  SANDBOX_FLAG,
...
export async function handleValidateBatch(request: Request) {
  try {
