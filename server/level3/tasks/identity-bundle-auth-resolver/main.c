...
__attribute__((visibility("default"))) int auth_create_local_grant(
  ...
  (void)grant_id; (void)subject_id; (void)resource_id; (void)perms_mask;
  (void)not_before_ts; (void)expires_ts; (void)delegatable;
  return 0;
}
...
__attribute__((visibility("default"))) int auth_import_bundle_grant(
  ...
  (void)grant_id; (void)subject_id; (void)resource_id; (void)perms_mask;
  (void)not_before_ts; (void)expires_ts; (void)delegatable; (void)requires_key;
  return 0;
}
...
__attribute__((visibility("default"))) int auth_delegate(
  ...
  (void)parent_grant_id; (void)child_grant_id; (void)subject_id; (void)resource_id;
  (void)perms_mask; (void)not_before_ts; (void)expires_ts; (void)delegatable; (void)requires_key;
  return 0;
}
...
__attribute__((visibility("default"))) int auth_audit_get(
  ...
  (void)grant_id; (void)ts; (void)out_view;
  return 0;
}
