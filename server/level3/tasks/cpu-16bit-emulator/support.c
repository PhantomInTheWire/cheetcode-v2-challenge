...
int ct_get_pc(void) { return pc; }

int ct_get_sp(void) { return sp; }

int ct_get_flag_z(void) { return flag_z; }

int ct_get_flag_n(void) { return flag_n; }

int ct_get_flag_v(void) { return flag_v; }
