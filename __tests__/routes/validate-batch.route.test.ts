...
async function getPost() {
  return (await import("../../src/app/api/dev/validate-batch/route")).POST;
}

describe("/api/dev/validate-batch", () => {
  it("validates multiple items independently in one batch", async () => {
    const req = new Request("http://localhost/api/dev/validate-batch", {
      method: "POST",
